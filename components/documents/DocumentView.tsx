...
export const DocumentView: React.FC<DocumentViewProps> = ({
  ...
  return (
    <div className="space-y-6">
      {/* Document Header */}
      <div className="flex items-start justify-between mb-6 pb-6 border-b border-cairos-border">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-3">
            <h1 className="text-h1 text-gray-900">{document.title || document.type}</h1>
          </div>
      ...
      {/* Metadata Grid */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-body-sm mb-6 pb-6 border-b border-cairos-border">
      ...
      {document.addendums && document.addendums.length > 0 && (
        <div className="pt-6 border-t border-cairos-border">
